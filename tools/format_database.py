...
tax_db = pd.read_csv("data/database/12S_Kankakee_db_1117.tsv", sep="\t")

with open("data/database/vsearch_ref_seqs.fasta", "w") as f:
...
tax_db_noseq.to_csv("data/database/vsearch_ref_taxa.tsv", sep="\t", index=False)